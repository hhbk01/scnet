...
class SCNet(Deep_Net):
    ...
    def layer(self, shape, num_classes, num_features):
        """
        scnet layer
        :param shape: the type of data shape is [img.shape,txt.shape],img.shape:(w,h,c) ,txt.shape:(txt_dim,)
        :param num_classes: Classification number
        :param num_features: input_dim, the param of Embedding layer
        :return:
        """
